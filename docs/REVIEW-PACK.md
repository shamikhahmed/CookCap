# CookCap — Claude / agent review pack (v3.4.1)
...
**Version:** 3.4.1 · SW `cookcap-v38` · Catalog **790**
...
| Ver | What |
|-----|------|
| **3.4.1** | Bible §9 micros + onboard→flip 60fps proof (`recordings/onboard-flip.*`) |
| **3.4.0** | Type ≥16 / taps 44 / WhatsNew corner / hero + tab polish / flip depth |
