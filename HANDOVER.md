...
Heirloom family cookbook PWA (Cap family). Version **3.0.1**.
...
Next.js 15 · React 19 · TypeScript · Tailwind v4 · Motion · IndexedDB v4 (`cookcap`, migrates `jia-cooks`) · SW `cookcap-v30`
