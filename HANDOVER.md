...
Heirloom family cookbook PWA (Cap family). Version **3.2.1**.
...
Next.js 15 · React 19 · TypeScript · Tailwind v4 · Motion · IndexedDB v4 (`cookcap`, migrates `jia-cooks`) · SW `cookcap-v33`
...
- **v3.2.1** reading desk = real wood (`--dr-wood`), not cream; phone chrome wood-tinted
