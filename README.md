...
**Live:** https://shamikhahmed.github.io/CookCap/ · **v2.2.6**
...
- Dresser first-run (Simple fallback) + safe-area chrome on notched devices

## Stack

Next.js 15 (`output: 'export'`) · React 19 · Tailwind v4 · Motion · IndexedDB · SW `cookcap-v12`
