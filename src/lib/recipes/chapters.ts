...
export const CHAPTERS: Chapter[] = [
  ...
  {
    id: 'favorites',
    title: 'Jia’s Favorites',
    subtitle: 'The ones I make most',
    blurb: 'The recipes I come back to again and again. Tap a heart, and yours gather here too.',
    quote: '“If I could only keep a handful, it would be these.”',
    tab: '#c98a2e',
    icon: 'heart',
  },
  {
